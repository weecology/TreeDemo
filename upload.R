...
upload_page<-function(){
  renderUI({
    fluidPage(
      ...
      p(style = "font-size:25px","The tree detection model has been trained on 40m by 40m images from fixed-wing aircraft. Performance will likely be best at these spatial scales. We recommend cropping a small portion of an image to upload for testing purposes."), 
