...
about_page<-function(){
  renderUI({
    fluidPage(
      ...
      p(style="font-size:25px", "The goal of this project is to provide RGB tree detection at broad spatial scales. The goal is not to replace traditional ground survey techniques, or suggest they can be replaced by automated approaches. While the segmentations are not perfect, the aim is to provide an opportunity to scale beyond traditional plot level measures. Whether this best fits your scientific question depends on the sensitivity of your data to segmentation results."),
      h1("Ben Weinstein"),
